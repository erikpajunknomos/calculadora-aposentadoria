...
function showErrorOverlay(msg: string, stack?: string) {
  ...
  div.style.cssText = "position:fixed;inset:12px;z-index:999999;padding:12px;border:1px solid #ef4444;background:#fef2f2;color:#991b1b;border-radius:12px;font-family:ui-sans-serif,system-ui;box-shadow:0 4px 16px rgba(0,0,0,.1);overflow:auto;maxHeight:80vh";
  div.innerHTML = \`
    <div style="font-weight:600;margin-bottom:8px">Erro em runtime</div>
    <div style="font-size:14px;white-space:pre-wrap">\${msg}</div>
    \${stack ? '<pre style="margin-top:8px;font-size:12px;white-space:pre-wrap">'+stack+'</pre>' : ''}
  \`;
